...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
                http.csrf().disable()
                .authorizeRequests()
                        .antMatchers("/admin/building-edit","/admin/user-list", "/admin/user-edit", "/admin/user-edit-{id}").hasAnyRole("MANAGER")
                        .antMatchers("/admin/customer-edit").hasAnyRole("STAFF", "MANAGER")
